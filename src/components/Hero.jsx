      ...
      <div className="section-container text-center">
        ...
        >
          <motion.h1 variants={itemVariants} className="heading-primary mb-6">
            <motion.span 
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl block mb-2"
            >
              I build, test, and automate
            </motion.span>
            <motion.span 
              variants={itemVariants}
              className="text-primary-600 text-2xl sm:text-3xl md:text-4xl lg:text-5xl block"
            >
          ...
          <motion.p 
            variants={itemVariants}
            className="text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 sm:mb-12 max-w-3xl mx-auto px-4"
          >
            Hi, I'm Leigh James — a Software QA Tester, Aspiring Frontend Developer, and Sales Funnel Automation Freelancer.
          </motion.p>

          <motion.div 
            variants={itemVariants}
            className="flex flex-col sm:flex-row gap-4 justify-center mb-6 sm:mb-8 px-4"
          >
          ...
          <motion.div 
            variants={itemVariants}
            className="flex justify-center items-center gap-4 sm:gap-6 mb-8 sm:mb-12"
          >
            <a
        ...
        >
          <Link to="about" smooth={true} className="animate-bounce cursor-pointer">
            <ArrowDownIcon className="h-6 w-6 sm:h-8 sm:w-8 text-gray-400" />
          </Link>
        </motion.div>
      </div>
    </section>
